            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu">
                        ...
                        <ul>
                            <!-- abaixo fizemos um include do nosso template de categorias que vamos criar -->
                            <?php require $this->checkTemplate("categories-menu");?>
                            <!-- as linhas abaixo foram retiradas por sugestão do professor para fazer este menu de categorias separado deste arquivo, para ficar de forma mais dinâminca -->
