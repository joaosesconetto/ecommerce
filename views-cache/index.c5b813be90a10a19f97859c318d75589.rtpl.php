                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    ...
                                    <div class="product-hover">
                                        ...
                                        <!-- href="/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/add direciona o produto no carrinho de compras -->
                                ...
                                <!-- link p/acessar a pasta onde esta o prod. e a url do produto -->
                                ...
                                <div class="product-carousel-price">
                                    <!--A 2ª tag seria o desc, como não temos colomos só o vl. -->
                                    <!-- <ins>$700.00</ins> <del>$100.00</del> -->
                                    <!-- a function "formatPrice estou trazendo do arquivo functions.php " -->
